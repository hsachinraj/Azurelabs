...
6. Login to Azure Portal from [here](https://portal.azure.com) and verify that you don’t have any your resource group created at this
 moment.

    <img src="./media2/image12.png" width="466" height="379" />

7.  Right click on the project from Solution Explorer &gt; click
    “Deploy” &gt; select “New Deployment”

    <img src="./media2/image13.png" width="497" height="433" />

8.  A new window appears; select the Subscription you want to
...
9.  Click on edit parameters and fill out the required details as shown-
...
11.  You will be prompted with a window to enter the db credentials.
...
12.  Post deployment, you will be seeing the resources in your Azure-
